...
const Palette = React.memo(({ location }) => {
    ...
    const paletteLink = window.location.origin.toString() + location.pathname
    ...
    useEffect(() => {
        if (localAddedPalettes && localAddedPalettes.length && currentPalette) {
            ...
            <div className="palette-meta">
                <div className="palette-link">
                    ...
                    <Tippy
                        // options
                        content={
                            copySuccess ? `Link copied!` : 'Copy palette link'
                        }
                        placement="top"
                        trigger="mouseenter"
                        size="small"
                        ...
                        hideOnClick="toggle"
                    >
                        <span className="copy-hex" onClick={copyPaletteLink}>
                            <Copy />
                        </span>
                    </Tippy>
                </div>
