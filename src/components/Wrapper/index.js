...
const Wrapper = ({ children, location }) => {
    ...
    return (
        ...
        >
            <Helmet>
                <title>
                    Hexy{currentPath && ` - ${humanize(currentPath)}`}
                </title>
                <meta
                    name="description"
                    content={`Explore ${num} named hex colors.`}
                />

                <meta
                    property="og:url"
                    content={`${window.location.origin.toString()}/${currentPath}`}
                />
                <meta property="og:type" content="website" />
                <meta
                    property="og:title"
                    content={`Hexy${currentPath &&
                        ' - ' + humanize(currentPath)}`}
                />
                <meta
                    property="og:image"
                ...
                <meta
                    ...
                    content="Hexy home page with colors"
                />
                <meta property="og:image:width" content="1200" />
                <meta property="og:image:height" content="630" />
                <meta
                    property="og:description"
                    ccontent={`Explore ${num} named hex colors.`}
                />
