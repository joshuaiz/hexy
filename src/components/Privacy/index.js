...
const Privacy = () => {
    return (
        <div className="privacy-policy">
            <ScrollToTop />
            <h1>Hexy Privacy Policy</h1>
            <p>
                Hexy (the “Company”) is committed to maintaining robust privacy
            ...
            <p>
                ...
                <a href="https://hexy.io/">https://hexy.io</a>.
            </p>
            <p>
                “Service” refers to the Company’s services accessed via the
                Site, in which users can explore colors, save palettes and share
                favorite colors.
            </p>
            ...
            <p>
                ...
                <a href="https://hexy.io/terms">https://hexy.io/terms</a>), and
                you consent to our collection, storage, use and disclosure of
            ...
            <p>
                ...
                submit and number of clicks. Personal Information includes your
                email, which you submit to us through the registration process
                at the Site.
            </p>
            ...
            <p>
                ...
                Service, we track information provided to us by your browser or
                by our software application when you view or use the Service,
                such as the website you came from (known as the “referring
                ...
                anonymous unique identifier. Cookies are sent to a user’s
                browser from our servers and are stored on the user’s computer
                hard drive. Sending a cookie to a user’s browser enables us to
            ...
            <ul>
                ...
                <li>shared/saved palettes</li>
                <li>palette likes</li>
                <li>
                    account details: account type, status, creation date,
                    upgrades
                </li>
                <li>shopping cart</li>
                <li>search terms</li>
            ...
            <p>
                ...
                when you close your browser. For example, we store a persistent
                cookie to save your shopping cart and favorites.
            </p>
            ...
            such information, please contact us at support @ hexy dot io.
            ...
            <p>
                ...
                either unsubscribing, we may continue to send you administrative
                emails including, for example, periodic updates to our Privacy
                Policy.
            </p>
            ...
            <p>
                ...
                email address specified in your account or by placing a
                prominent notice on our site. Significant changes will go into
                effect 30 days following such notification. Non-material changes
                or clarifications will take effect immediately. You should
                periodically check the Site and this privacy page for updates.
            </p>
            <h2>VII. Contact Us</h2>
            <p>
                If you have any questions regarding this Privacy Policy or the
                practices of this Site, please{' '}
                <a href="https://hexy.io/contact">contact us</a>.
            </p>
            <p>
